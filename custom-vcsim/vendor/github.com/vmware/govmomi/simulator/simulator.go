...
func (s *Service) ServiceVersionsVsan(w http.ResponseWriter, r *http.Request) {
 ...
 <namespace>
  ...
  <version>%s</version>
  <priorVersions>
   <version>vsan.version.version16</version>
   <version>vsan.version.version15</version>
   <version>vsan.version.version14</version>
   <version>vsan.version.version13</version>
   <version>vsan.version.version12</version>
   <version>vsan.version.version11</version>
   <version>vsan.version.version10</version>
   <version>vsan.version.version9</version>
   <version>vsan.version.version8</version>
   <version>vsan.version.version7</version>
   <version>6.7</version>
   <version>6.6</version>
  </priorVersions>
 </namespace>

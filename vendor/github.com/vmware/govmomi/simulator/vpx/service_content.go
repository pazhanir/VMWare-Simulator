...
var ServiceContent = types.ServiceContent{
	...
	About: types.AboutInfo{
		...
		FullName:              "VMware vCenter Server 8.0.2 build-21997540",
		Vendor:                "VMware, Inc.",
		Version:               "8.0.2",
		Build:                 "21997540",
		LocaleVersion:         "INTL",
	...
	GuestCustomizationManager:   &types.ManagedObjectReference{Type: "VirtualMachineGuestCustomizationManager", Value: "GuestCustomizationManager"},
	SiteInfoManager:             &types.ManagedObjectReference{Type: "SiteInfoManager", Value: "SiteInfoManager"},
	StorageQueryManager:         &types.ManagedObjectReference{Type: "StorageQueryManager", Value: "StorageQueryManager"},
}

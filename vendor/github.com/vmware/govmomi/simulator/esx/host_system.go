...
var HostSystem = mo.HostSystem{
	...
	Summary: types.HostListSummary{
		...
		QuickStats: types.HostListSummaryQuickStats{
			DynamicData:               types.DynamicData{},
			OverallCpuUsage:           44800,
			OverallMemoryUsage:        340787,
			DistributedCpuFairness:    4096,
			DistributedMemoryFairness: 2048,
			Uptime:                    1209600,
		},
		OverallStatus:      "green",
	...
	SystemResources: &types.HostSystemResourceInfo{
		...
		Config: &types.ResourceConfigSpec{
			MemoryAllocation: types.ResourceAllocationInfo{
				Limit:       types.NewInt64(524288), // 512 GB in MB
				Reservation: types.NewInt64(0),
			},
			CpuAllocation: types.ResourceAllocationInfo{
				Limit:       types.NewInt64(-1), // unlimited
				Reservation: types.NewInt64(0),
			},
		},
	},
